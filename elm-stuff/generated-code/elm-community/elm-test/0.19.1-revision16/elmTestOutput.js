...
var $elm_explorations$test$Test$Internal$ElmTestVariant__Batch = function (a) {
	return {__elmTestSymbol: __elmTestSymbol, __elmTestSymbol: __elmTestSymbol, __elmTestSymbol: __elmTestSymbol, __elmTestSymbol: __elmTestSymbol, __elmTestSymbol: __elmTestSymbol, $: 'ElmTestVariant__Batch', a: a};
};
...
var $elm_explorations$test$Test$Internal$ElmTestVariant__UnitTest = function (a) {
	return {__elmTestSymbol: __elmTestSymbol, __elmTestSymbol: __elmTestSymbol, __elmTestSymbol: __elmTestSymbol, __elmTestSymbol: __elmTestSymbol, __elmTestSymbol: __elmTestSymbol, $: 'ElmTestVariant__UnitTest', a: a};
};
...
var $elm_explorations$test$Test$Internal$ElmTestVariant__Labeled = F2(
	function (a, b) {
		return {__elmTestSymbol: __elmTestSymbol, __elmTestSymbol: __elmTestSymbol, __elmTestSymbol: __elmTestSymbol, __elmTestSymbol: __elmTestSymbol, __elmTestSymbol: __elmTestSymbol, $: 'ElmTestVariant__Labeled', a: a, b: b};
	});
...
var $author$project$VectorTest$tests = A2(
	...
	_List_fromArray(
		[
			...
			'add two vectors',
			function (_v0) {
				var b = $author$project$Vector$fromList(
					_List_fromArray(
						[4, 5, 6]));
				var a = $author$project$Vector$fromList(
					_List_fromArray(
						[1, 2, 3]));
				return A2(
					$elm_explorations$test$Expect$equal,
					$author$project$Vector$toList(
						A2($author$project$Vector$add, a, b)),
					_List_fromArray(
						[5, 7, 9]));
			})
		]));
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['C:\\Users\\Administrator\\Desktop\\elm-ml\\tests\\Example.elm', 'C:\\Users\\Administrator\\Desktop\\elm-ml\\tests\\VectorTest.elm']),
		processes: 12,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: 100,
		seed: 305170947931634
	},
	_List_fromArray(
		[
			_Utils_Tuple2(
...
var pipeFilename = "\\\\.\\pipe\\elm_test-21752-1";
var net = require('net'),
  client = net.createConnection(pipeFilename);
...
var pipeFilename = "\\\\.\\pipe\\elm_test-17560-1";
var net = require('net'),
  client = net.createConnection(pipeFilename);
...
var pipeFilename = "\\\\.\\pipe\\elm_test-21556-1";
var net = require('net'),
  client = net.createConnection(pipeFilename);
...
var pipeFilename = "\\\\.\\pipe\\elm_test-7384-1";
var net = require('net'),
  client = net.createConnection(pipeFilename);
